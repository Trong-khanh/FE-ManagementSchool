...
import { getDailyScores, getSubjectsAverageScores, getAverageScores } from '../../API /StudentAPI';
...
const ViewStudent = () => {
    ...
    return (
        <div className="view-parent-container">
            <NavBarStudent searchQuery={searchQuery} onSearchChange={handleSearchChange} />
